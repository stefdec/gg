    ...
    <div class="scrollbar-inner scroll-scrollx_visible">
        <div class="sidenav-header d-flex align-items-center">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('argon') }}/img/brand/long-logo-blue.png" class="navbar-brand-img" alt="...">
            </a>
            <div class="ml-auto">
                <!-- Sidenav toggler -->
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    {{-- My nav bar --}}
                    <li class="nav-item active {{ $elementName == 'dashboards' ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ $parentSection == 'customers' ? 'active' : '' }}">
                        <a class="nav-link collapsed" href="#navbar-customers" data-toggle="collapse" role="button" aria-expanded="{{ $parentSection == 'customers' ? 'true' : '' }}" aria-controls="navbar-customers">
                            <i class="fas fa-address-book text-orange"></i>
                            <span class="nav-link-text">{{ __('Customers') }}</span>
                        </a>
                        <div class="collapse {{ $parentSection == 'customers' ? 'show' : '' }}" id="navbar-customers">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'customersOpen' ? 'active' : '' }}">
                                    <a href="{{ route('customersOpen') }}" class="nav-link">{{ __('Open files') }}</a>
                                </li>
                                <li class="nav-item {{ $elementName == 'customersClose' ? 'active' : '' }}">
                                    <a href="{{ route('page.index','dashboard-alternative') }}" class="nav-link">{{ __('Closed files') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>

                    <li class="nav-item {{ $elementName == 'staff' ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ $elementName == 'rentals' ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('page.index','rentals') }}">
                            <i class="ni ni-spaceship text-green"></i>
                            <span class="nav-link-text">{{ __('Rentals') }}</span>
                        </a>
                    </li>

                    <li class="nav-item {{ $elementName == 'expenses' ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('page.index','expenses') }}">
                            <i class="ni ni-money-coins text-red"></i>
                            <span class="nav-link-text">{{ __('Expenses') }}</span>
                        </a>
                    </li>

                    <li class="nav-item {{ $elementName == 'reports' ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('page.index','reports') }}">
                            <i class="ni ni-chart-bar-32 text-info"></i>
                            <span class="nav-link-text">{{ __('Reports') }}</span>
                        </a>
                    </li>

                    <li class="nav-item {{ $parentSection == 'settings' ? 'active' : '' }}">
                        <a class="nav-link collapsed" href="#navbar-settings" data-toggle="collapse" role="button" aria-expanded="{{ $parentSection == 'settings' ? 'true' : '' }}" aria-controls="navbar-settings">
                            <i class="ni ni-settings-gear-65 text-yellow"></i>
                            <span class="nav-link-text">{{ __('Settings') }}</span>
                        </a>
                        <div class="collapse {{ $parentSection == 'setings' ? 'show' : '' }}" id="navbar-settings">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item {{ $elementName == 'customersOpen' ? 'active' : '' }}">
                                    <a href="{{ route('profile.edit') }}" class="nav-link">{{ __('My Account') }}</a>
                                </li>
                                <li class="nav-item {{ $elementName == 'customersClose' ? 'active' : '' }}">
                                    <a href="{{ route('customersOpen') }}" class="nav-link">{{ __('Expenses') }}</a>
                                </li>
                                <li class="nav-item {{ $elementName == 'customersClose' ? 'active' : '' }}">
                                    <a href="{{ route('customersOpen') }}" class="nav-link">{{ __('Agents') }}</a>
                                </li>
                                <li class="nav-item {{ $elementName == 'SettingsDisciplines' ? 'active' : '' }}">
                                    <a href="{{ route('settings.disciplines') }}" class="nav-link">{{ __('Activities') }}</a>
                                </li>
                                <li class="nav-item {{ $elementName == 'customersClose' ? 'active' : '' }}">
                                    <a href="{{ route('settings.staff.show') }}" class="nav-link">{{ __('Staff') }}</a>
                                </li>
                                <li class="nav-item {{ $elementName == 'customersClose' ? 'active' : '' }}">
                                    <a href="{{ route('customersOpen') }}" class="nav-link">{{ __('Inventory') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                <h6 class="navbar-heading p-0 text-muted">{{auth()->user()->name}}</h6>
                <!-- Navigation -->
