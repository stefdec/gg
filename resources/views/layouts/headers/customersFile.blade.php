<div class="row align-items-center py-4">
    ...
    @else
        <div class="col-lg-6 col-5 text-right">
            ...
            <a href="{{ route('customer.invoice', ['customerId'=>$customerId, 'customerLastName'=>$customerLastName, 'customerFirstName'=>$customerFirstName, 'logo'=>'logo']) }}" target='_blank' class="btn btn-neutral">{{ __('Invoice') }}</a>
        </div>
    @endif
</div>
